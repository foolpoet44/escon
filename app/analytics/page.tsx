...
export default function AnalyticsPage() {
    ...
    const skillTypeData = [
        { name: 'Knowledge', value: stats.knowledgeSkills, color: '#4ECDC4' },
        { name: 'Skill/Competence', value: stats.competenceSkills, color: '#667eea' }
    ];
        ...
        <main className="page-container">
            <div className="page-header">
                ...
                <p className="page-description">
                    Statistical insights and visualizations of the ESCO Skills Ontology
                </p>
            </div>
            ...
            <div className="stats-grid">
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-content">
                        ...
                        <div className="stat-label">Knowledge Skills</div>
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-content">
                        ...
                        <div className="stat-label">Competence Skills</div>
                        <div className="stat-percentage">
            ...
            <div className="charts-grid">
                <div className="chart-card">
                    <h2 className="chart-title">Skill Type Distribution</h2>
                ...
                <div className="chart-card chart-card-wide">
                    <h2 className="chart-title">Skills by Domain</h2>
